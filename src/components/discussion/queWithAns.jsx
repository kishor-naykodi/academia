...
function QuestionWithAns(params) {
  ...
  function Tags() {
    if (questionWithAns.question.tags) {
      return questionWithAns.question.tags.map((item) => {
        return <div className="tags">{item}</div>;
      });
    } else {
      return <div></div>;
    }
  ...
  function Answer() {
    if (questionWithAns.answer) {
      return questionWithAns.answer.map((item) => {
        return (
          <div className="detail_answer_container">
            <div className="answer_detail">
              ...
              <div className="answer_detail_answer">{item.answer}</div>
            </div>
          </div>
        );
      });
          ...
          >
            <Box sx={style}>
              <div className="submitAnswerContainer">
                <div className="submitAnswerTitle">Enter Your Answer</div>
                <div>
                  <textarea
